 ...
 */
MainProgram.prototype.mapsMakeStageData = function(
	i // 新形式マップの処理
) {
	var i3;
	var as;
 ...
 * @private
 */
MainProgram.prototype.readCustomParts = function(customParts) {
	...
	if (this.j_cannon_c > 0) {
		...
		if (this.co_j.jimen_f || this.j_hashigo_f || this.j_cannon_c == 0)
			if (
				this.jst_pc_attack >= 1 &&
				this.j_cannon_c > 0 &&
				(this.j_cannon_type == 3 || this.j_cannon_type == 4)
			) {
				if (this.j_hashigo_f) {
					this.j_cannon_c = 0;
			...
			if (this.yo[this.yuka_ride_id].con >= 200 && this.yo[this.yuka_ride_id].con < 300) {
				...
				if (i22 >= 0) {
					...
					this.co_j.y =
						this.yo[this.yuka_ride_id].y -
						Math.floor(
							Math.sqrt(this.yo[this.yuka_ride_id].x2 * this.yo[this.yuka_ride_id].x2 - j22 * j22)
						) -
						32;
				}
				...
				if (characterobject.c >= 400 && characterobject.c < 500) {
					...
					if (
						...
						if (
							...
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject.x + 31, 5) * 32,
								characterobject.y + 64
							) < 18 &&
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject.x + 31, 5) * 32 + 31,
								characterobject.y + 64
							) < 18 &&
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject.x + 31, 5) * 32 + 63,
								characterobject.y + 64
							) < 18 &&
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject.x + 31, 5) * 32 + 95,
								characterobject.y + 64
							) < 18
						)
							characterobject.x = rightShiftIgnoreSign(characterobject.x + 31, 5) * 32;
			...
			if (this.yo[this.yuka_ride_id].con >= 200 && this.yo[this.yuka_ride_id].con < 300) {
				...
				if (l24 >= 0) {
					...
					this.co_j.y =
						this.yo[this.yuka_ride_id].y -
						Math.floor(
							Math.sqrt(this.yo[this.yuka_ride_id].x2 * this.yo[this.yuka_ride_id].x2 - i25 * i25)
						) -
						32;
				}
			} else if (this.yo[this.yuka_ride_id].con >= 350 && this.yo[this.yuka_ride_id].con < 400) {
				...
				if (characterobject1.c >= 400 && characterobject1.c < 500) {
					...
					if (
						...
						if (
							...
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject1.x, 5) * 32,
								characterobject1.y + 64
							) < 18 &&
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject1.x, 5) * 32 + 31,
								characterobject1.y + 64
							) < 18 &&
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject1.x, 5) * 32 + 63,
								characterobject1.y + 64
							) < 18 &&
							this.maps.getBGCode(
								rightShiftIgnoreSign(characterobject1.x, 5) * 32 + 95,
								characterobject1.y + 64
							) < 18
						)
							characterobject1.x = rightShiftIgnoreSign(characterobject1.x, 5) * 32;
		...
		if (this.gk.tr1_c >= 1 && this.gk.tr1_c <= 5) {
			if (
				...
				(this.maps.getBGCode(this.co_j.x + 15, this.co_j.y - 1) == 18 &&
					!this.map_data_option[rightShiftIgnoreSign(this.co_j.x + 15, 5)][
	...
	if (this.j_tail_ac >= 1) {
		...
		if (this.j_tail_ac <= 4) {
			...
			if (this.j_tail_type == 2 || this.j_tail_type == 3) {
				...
				if (
					this.maps.map_bg[i16][k18] == 20 ||
					(this.maps.map_bg[i16][k18] == 69 && this.suberuyuka_hkf == 1)
				) {
...
MainProgram.prototype.jM100stg = function() {
	...
	if (this.xkey_c == 1) {
		...
		if (this.j_drell_f && (i7 == 20 || (i7 == 69 && this.suberuyuka_hkf == 1))) {
			...
			if (
				this.maps.map_bg[k4][k5 - 1] == 4 ||
				this.maps.map_bg[k4 - 1][k5] == 4 ||
				this.maps.map_bg[k4 + 1][k5] == 4
			)
	...
	if (this.co_j.c == 110) {
					...
					do {
						...
						if (
							...
							(this.co_j.c2 < 100 || this.co_j.c2 >= 200 || this.co_j.c5 != 1
								...
								: this.co_a[k].c == 300 &&
								  this.co_a[k].c4 != 1 &&
								  this.co_j.c2 == this.co_a[k].c3 + 100)
						) {
		...
		if (this.co_j.c1 > 48) {
			...
			this.co_j.x =
				...
				16 +
				rounddown(
					Math.cos((this.co_a[this.j_rope_id].c4 * 3.1415926535897931) / 180) * this.co_j.c1,
					true,
					this
				) -
				16;
			this.co_j.y =
				...
				16 +
				rounddown(
					Math.sin((this.co_a[this.j_rope_id].c4 * 3.1415926535897931) / 180) * this.co_j.c1,
					true,
					this
				) -
				16;
		...
		if (this.tr1_c >= 1 && this.tr1_c <= 5 && this.co_a[this.j_rope_id].c4 % 15 == 0 && this.co_j.c1 <= 48) {
			...
			this.co_j.ac = 0;
			this.co_j.c = 100;
			this.co_j.vx = rounddown(
				Math.cos((this.co_a[this.j_rope_id].c4 * 3.1415926535897931) / 180) * 160,
				true,
				this
			);
			this.co_j.vy = rounddown(
				Math.sin((this.co_a[this.j_rope_id].c4 * 3.1415926535897931) / 180) * 160,
				true,
				this
			);
			this.j_jump_level = 5;
	...
	do {
		...
		if (this.co_t[i].c <= 0) {
			...
			if (partsDefinition != null) {
				...
				partsDefinition.native.initFactory(characterobject.c2, partsDefinition.properties)(
					characterobject,
					this
				);
				// コントローラーを設定
	...
	do {
		...
		if (this.co_t[i1].c <= 0) {
			...
			if (partsDefinition != null) {
				...
				partsDefinition.native.initFactory(characterobject.c, partsDefinition.properties)(
					characterobject,
					this
				);
				// コントローラーを設定
 ...
 * @private
 */
MainProgram.prototype.getEnemyDefinition = function(code) {
		...
		switch (characterobject.c) {
			...
			case 110: // ファイヤーボール ホーミングアミュレット
				...
				for (var j2 = 0; j2 <= this.t_kazu; j2++) {
					if (
						...
						continue;
					var k7 =
						Math.abs(this.co_t[j2].x - characterobject.x) + Math.abs(this.co_t[j2].y - characterobject.y);
					if (k7 < l11) {
						j15 = j2;
						l11 = k7;
					}
			...
			case 200: // グレネード
				...
				if (characterobject.c4 == 2) characterobject.y += characterobject.vy;
					...
					if (
						characterobject.vy > 0 &&
						this.maps.getBGCode(characterobject.x + 15, characterobject.y + 31) >= 18
					) {
						characterobject.c = 50;
						characterobject.y = rightShiftIgnoreSign(characterobject.y + 31, 5) * 32 - 16;
						characterobject.c1 = 1;
		...
		switch (characterobject.c) {
			...
			case 90: // シーソー
				if (
					...
					var j85 =
						k3 +
						rounddown(Math.cos(((characterobject.vy + 180) * 3.1415926535897931) / 180) * 160, true, this);
					var k87 =
						l3 +
						rounddown(Math.sin(((characterobject.vy + 180) * 3.1415926535897931) / 180) * 160, true, this);
					var l89 =
						k3 + rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * 160, true, this);
					var k92 =
						l3 + rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * 160, true, this);
					j85 += rounddown(
						Math.cos(((characterobject.vy + 270) * 3.1415926535897931) / 180) * 12,
						true,
						this
					);
					k87 += rounddown(
						Math.sin(((characterobject.vy + 270) * 3.1415926535897931) / 180) * 12,
						true,
						this
					);
					...
					this.setYukaPosition(
						String(characterobject.c4),
						String(j85),
						String(k87),
						String(l89),
						String(k92)
			...
			case 93: // ブランコ
				...
				var k85 =
					k3 + rounddown(Math.cos(((characterobject.vy + 20) * 3.1415926535897931) / 180) * 192, true, this);
				var l87 =
					l3 + rounddown(Math.sin(((characterobject.vy + 20) * 3.1415926535897931) / 180) * 192, true, this);
				var i90 =
					k3 + rounddown(Math.cos(((characterobject.vy - 20) * 3.1415926535897931) / 180) * 192, true, this);
				var l92 =
					l3 + rounddown(Math.sin(((characterobject.vy - 20) * 3.1415926535897931) / 180) * 192, true, this);
				...
				if (characterobject.c4 <= 1) {
					...
					if (characterobject.c3 == 0) {
						if (
							...
							if (
								this.maps.map_bg[j9][i26] < 18 &&
								this.maps.map_bg[j9][k49] < 18 &&
								this.maps.map_bg[j9][k63] < 18
							)
								characterobject.c3 = 1;
						}
					} else if (characterobject.c3 < 100) {
					...
					if (characterobject.c3 == 0) {
						if (
							...
							if (
								this.maps.map_bg[l9][k26] < 18 &&
								this.maps.map_bg[l9][i50] < 18 &&
								this.maps.map_bg[l9][i64] < 18
							)
								characterobject.c3 = 1;
						}
					} else if (characterobject.c3 < 100) {
			...
			case 1300: // ロープ
				...
				if (this.co_j.c >= 100 && this.co_j.c < 200)
					if (this.j_rope_cf && this.j_rope_id == i) {
						var j79 =
							l3 + rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * 32, true, this);
						var l93 =
							l3 + rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * 184, true, this);
						if (this.co_j.y + 16 < j79 - 48 || this.co_j.y + 16 > l93 + 24) this.j_rope_cf = false;
						var j73 =
							k3 + rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * 32, true, this);
						...
						if (this.co_j.y + 16 >= k79 && this.co_j.y + 16 <= i94) {
							var k73 =
								k3 +
								rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * 32, true, this);
							var j91 =
								k3 +
								rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * 184, true, this);
			...
			case 1500: // 人間大砲
				...
				if (this.j_rope_cf && this.j_rope_id == i) {
					var i74 =
						k3 + 16 + rounddown(Math.cos((characterobject.c4 * 3.1415926535897931) / 180) * 60, true, this);
					var i80 =
						l3 + 16 + rounddown(Math.sin((characterobject.c4 * 3.1415926535897931) / 180) * 60, true, this);
					...
					var j74 =
						k3 + 16 + rounddown(Math.cos((characterobject.c4 * 3.1415926535897931) / 180) * 80, true, this);
					var j80 =
						l3 + 16 + rounddown(Math.sin((characterobject.c4 * 3.1415926535897931) / 180) * 80, true, this);
			...
			case 1800: // 回転するドッスンスン
				...
				if (characterobject.gf) {
					var l86 =
						k3 +
						rounddown(
							Math.cos(((characterobject.vy + 180 + 34) * 3.1415926535897931) / 180) * 87,
							true,
							this
						);
					var i89 =
						l3 +
						rounddown(
							Math.sin(((characterobject.vy + 180 + 34) * 3.1415926535897931) / 180) * 87,
							true,
							this
						);
					var l91 =
						k3 +
						rounddown(
							Math.cos(((characterobject.vy + 360 - 34) * 3.1415926535897931) / 180) * 87,
							true,
							this
						);
					var k94 =
						l3 +
						rounddown(
							Math.sin(((characterobject.vy + 360 - 34) * 3.1415926535897931) / 180) * 87,
							true,
							this
						);
					this.setYukaPosition(
						String(characterobject.c3),
						String(l86),
						String(i89),
						String(l91),
						String(k94)
					...
					l86 =
						k3 +
						rounddown(Math.cos(((characterobject.vy + 34) * 3.1415926535897931) / 180) * 87, true, this);
					i89 =
						l3 +
						rounddown(Math.sin(((characterobject.vy + 34) * 3.1415926535897931) / 180) * 87, true, this);
					this.setYukaPosition(
						String(characterobject.c4),
						String(l91),
						String(k94),
			...
			case 1850: // 回転する巨大ドッスンスン
				...
				if (characterobject.gf) {
					var i87 =
						k3 +
						rounddown(
							Math.cos(((characterobject.vy + 180 + 34) * 3.1415926535897931) / 180) * 144,
							true,
							this
						);
					var j89 =
						l3 +
						rounddown(
							Math.sin(((characterobject.vy + 180 + 34) * 3.1415926535897931) / 180) * 144,
							true,
							this
						);
					var i92 =
						k3 +
						rounddown(
							Math.cos(((characterobject.vy + 360 - 34) * 3.1415926535897931) / 180) * 144,
							true,
							this
						);
					var l94 =
						l3 +
						rounddown(
							Math.sin(((characterobject.vy + 360 - 34) * 3.1415926535897931) / 180) * 144,
							true,
							this
						);
					this.setYukaPosition(
					...
					i87 =
						k3 +
						rounddown(Math.cos(((characterobject.vy + 34) * 3.1415926535897931) / 180) * 144, true, this);
					j89 =
						l3 +
						rounddown(Math.sin(((characterobject.vy + 34) * 3.1415926535897931) / 180) * 144, true, this);
					this.setYukaPosition(
						String(characterobject.c4),
						String(i92),
						String(l94),
				...
				if (this.co_j.c >= 100 && this.co_j.c < 200)
					if (this.j_rope_cf && this.j_rope_id == i) {
						...
						if (j72 >= 12 && j72 <= 244) {
							var k75 =
								k3 +
								rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * j72, true, this);
							var j81 =
								l3 +
								rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * j72, true, this);
						...
						(this.co_j.c != 140 || this.j_rope_id != i) &&
						this.co_j.c == 100 &&
						!this.co_j.jimen_f
					) {
						...
						if (k72 >= 12 && k72 <= 220) {
							var l75 =
								k3 +
								rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * k72, true, this);
							var k81 =
								l3 +
								rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * k72, true, this);
				...
				if (this.co_j.c >= 100 && this.co_j.c < 200)
					if (this.j_rope_cf && this.j_rope_id == i) {
						...
						if (l72 >= 12 && l72 <= 244) {
							var i76 =
								k3 +
								rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * l72, true, this);
							var l81 =
								l3 +
								rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * l72, true, this);
						...
						if (i73 >= 12 && i73 <= 220) {
							var j76 =
								k3 +
								rounddown(Math.cos((characterobject.vy * 3.1415926535897931) / 180) * i73, true, this);
							var i82 =
								l3 +
								rounddown(Math.sin((characterobject.vy * 3.1415926535897931) / 180) * i73, true, this);
	...
	switch (characterobject.c) {
		...
		case 4400: // スイッチ式ブロック ＯＮで消える
			...
			if (characterobject.c3 == 100) {
				...
				for (
					var i24 = 0;
					i24 <= 3 && i12 + i24 <= this.mapWidth && this.maps.map_bg[i12 + i24][i18] == 23;
					i24++
				)
